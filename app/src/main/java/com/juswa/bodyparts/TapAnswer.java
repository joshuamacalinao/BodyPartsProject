...
import com.juswa.bodyparts.Questions.Q_tap;

import butterknife.BindView;
import butterknife.BindViews;
import butterknife.ButterKnife;

public class TapAnswer extends AppCompatActivity {
    ...
    private Q_tap questtion = new Q_tap();
    ...
    TextView question;
    @BindView(R.id.images) ImageView images;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tap_answer);
    ...
    private void updatequestion(){
        if (intQuestion < questtion.getLength())
        {
            new Handler().postDelayed(() -> {
                ...
                images.setImageResource(questtion.getQuestionImg(intQuestion));
